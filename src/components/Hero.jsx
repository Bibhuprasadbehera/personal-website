...
import { Github, Mail, FileText, Database, Linkedin, GraduationCap, BookOpen, Download } from 'lucide-react';
...
const Hero = () => {
    const links = [
        ...
        { href: '/personal-website/bibhu prasad CV (2025-dec)-1.pdf', icon: Download, label: 'Download CV', primary: false },
        { href: 'https://www.linkedin.com/in/bibhu-prasad-behera-b3a6b5203/', icon: Linkedin, label: 'LinkedIn', primary: false },
    ...
    const stats = [
        { label: 'Publications', value: '2 (till 2024)' },
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-8 text-center">
                ...
                >
                    <div className="mb-8 relative inline-block">
                        <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-bio-green/30 shadow-[0_0_30px_rgba(0,255,157,0.2)] relative z-10">
                            <img
                                src="/personal-website/IMG-20250809-WA0343.jpg"
                                alt="Bibhu Prasad Behera"
                                className="w-full h-full object-cover"
                            />
                        </div>
                        <div className="absolute -inset-4 bg-bio-green/20 blur-xl rounded-full -z-10 animate-pulse"></div>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        {links.map(({ href, icon: Icon, label, primary }) => (
                            <a
                                ...
                                className={`px-8 py-3 rounded-lg flex items-center gap-2 transition-colors ${primary
